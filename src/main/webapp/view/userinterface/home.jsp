                                ...
                                <div class="penci-mega-latest-posts col-mn-4 mega-row-1">
                                    ...
                                    <div class="penci-mega-row penci-mega-12">
                                        <div class="penci-mega-post">
                                            <div class="penci-mega-thumbnail">
                                                    <span class="mega-cat-name">
                                                        <a href="https://www.esheepkitchen.com/category/recipe/side-dishes/"
                                                           target="_blank">Món phụ</a>
                                                    </span>
                                                <a class="penci-image-holder"
                        ...
                        <li class="menu-item-0">
                            <div class="penci-megamenu">
                                <div class="penci-mega-child-categories">
                                    ...
                                    <a class="mega-cat-child"
                                       href="https://www.esheepkitchen.com/category/inspiration/nhat-ki-xay-mo/"
                                       data-id="penci-mega-201"
                                       target="_blank"><span>Nhật kí xây mơ</span></a>
                                    <a class="mega-cat-child cat-active all-style"
                                       href="https://www.esheepkitchen.com/category/inspiration/"
                                       data-id="penci-mega-15" target="_blank"><span>All</span></a>
                                </div>
...
<div id="container">
                ...
                <div class="wrapper-item wrapper-item-classess">
                    <div class="penci-item-mag penci-item-1">
                        <a class="penci-image-holder"
                           ...
                           href="https://www.esheepkitchen.com/squid-game-tro-choi-con-muc/"
                           title="[SQUID GAME] Trò chơi con mực" target="_blank"></a>
                        <div class="penci-slide-overlay penci-slider7-overlay">
                            <a class="overlay-link"
                               href="https://www.esheepkitchen.com/squid-game-tro-choi-con-muc/" target="_blank"></a>
                ...
                <div class="wrapper-item wrapper-item-classess">
                    <div class="penci-item-mag penci-item-2">
                        <a class="penci-image-holder"
                           ...
                           href="https://www.esheepkitchen.com/cach-lam-rose-roll-cake-banh-cuon-kem-phomai-bang-chao/"
                           title="CÁCH LÀM “ROSÉ ROLL CAKE” – BÁNH CUỘN KEM PHOMAI BẰNG… CHẢO" target="_blank"></a>
                        <div class="penci-slide-overlay penci-slider7-overlay">
                            <a class="overlay-link"
                               href="https://www.esheepkitchen.com/cach-lam-rose-roll-cake-banh-cuon-kem-phomai-bang-chao/"
                               target="_blank"></a>
                            <a href="https://www.esheepkitchen.com/cach-lam-rose-roll-cake-banh-cuon-kem-phomai-bang-chao/"
                               class="overlay-icon-format lager-size-icon" target="_blank">
                                <i class="fa fa-play"></i>
                            </a>
                            <div class="penci-mag-featured-content">
                                <div class="feat-text">
                ...
                <div class="wrapper-item wrapper-item-classess">
                    <div class="penci-item-mag penci-item-0">
                        <a class="penci-image-holder"
                           ...
                           href="https://www.esheepkitchen.com/ve-dep-cua-rau-cu/" title="Vẻ đẹp của rau củ"
                           target="_blank"></a>
                        <div class="penci-slide-overlay penci-slider7-overlay">
                            <a class="overlay-link" href="https://www.esheepkitchen.com/ve-dep-cua-rau-cu/"
                               target="_blank"></a>
                            <div class="penci-mag-featured-content">
                                <div class="feat-text">
                ...
                <div class="wrapper-item wrapper-item-classess">
                    <div class="penci-item-mag penci-item-2">
                        <a class="penci-image-holder"
                           ...
                           href="https://www.esheepkitchen.com/cach-lam-cha-ca-ha-noi-cha-ca-la-vong-bang-noi-chien-khong-dau/"
                           title="CÁCH LÀM CHẢ CÁ HÀ NỘI – CHẢ CÁ LÃ VỌNG BẰNG NỒI CHIÊN KHÔNG DẦU" target="_blank"></a>
                        <div class="penci-slide-overlay penci-slider7-overlay">
                            <a class="overlay-link"
                               href="https://www.esheepkitchen.com/cach-lam-cha-ca-ha-noi-cha-ca-la-vong-bang-noi-chien-khong-dau/"
                               target="_blank"></a>
    ...
    <div id="content" class="mx-auto">
        <div class="session">
            ...
            <div>
                <div class="item text-center">
                    <a href="${blog}"><img src="/template/asset/userinterface/img/2.jpg" alt=""></a>
                    <div>
            ...
            <p class="text-center"><a href="#" class="rounded">xem tiếp</a></p>
        </div>
        <hr>
        <div class="session">
            <h4>BÁNH NGỌT</h4>
...
<script type='text/javascript' src="<c:url value='/template/asset/userinterface/js/home.js'/>"></script>
